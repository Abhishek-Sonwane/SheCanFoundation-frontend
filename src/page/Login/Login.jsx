	...
	return (
		<div className="pt-44">
			<form className="max-w-xl mx-auto bg-white/50 px-10 py-6 rounded-2xl shadow-xl border border-gray-100">
				...
				<button
					type="submit"
					className="text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl w-full px-5 py-2.5 text-center dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800 mt-6"
				>
					Login
				</button>
